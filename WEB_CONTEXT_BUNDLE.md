...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-150-the-additive-basis-conjecture-fd7bd728-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-150"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-150-the-additive-basis-conjecture-fd7bd728-v1",
      "problem_contract_sha256": "d61bbe9c8c898a09f27de48f24f7b8c842eb2a0f3279937d0bf16b5596e8aa0b",
      "problem_id": "problem:um-opg-150-the-additive-basis-conjecture-fd7bd728",
      "route_id": "route:um-opg-150-the-additive-basis-conjecture-fd7bd728-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-150-the-additive-basis-conjecture-fd7bd728-source-fidelity-01",
      "graph_id": "graph:um-opg-150-the-additive-basis-conjecture-fd7bd728-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-150-the-additive-basis-conjecture-fd7bd728-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-150-the-additive-basis-conjecture-fd7bd728-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture For every prime $p$, there is a constant $c(p)$ (possibly $c(p)=p$ ) so that the union (as multisets) of any $c(p)$ bases of the vector space $({\\mathbb Z}_p)^n$ contains an additive basis."
          },
          "statement_sha256": "01fd51d96e299dc5bc66fff1f89af91e6da11b4a224e7b88f23dbf481ae90d49"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-150-the-additive-basis-conjecture-fd7bd728-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-150-the-additive-basis-conjecture-fd7bd728-root",
      "route_id": "route:um-opg-150-the-additive-basis-conjecture-fd7bd728-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-150-9a574c1b3116",
        "url": "https://www.unsolvedmath.com/problems/OPG-150"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
